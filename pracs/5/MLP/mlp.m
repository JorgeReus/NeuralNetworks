...
% inputs_path = strcat(input('Ingrese el nombre del archivo de inputs sin la extensiÛn: ','s'), '.txt');
inputs_path = 'inputs.txt';
inputs = importdata(inputs_path);

% Read the targets
%targets_file = strcat(input('Ingrese el nombre del archivo de targets sin la extensiÛn: ','s'), '.txt');
...
% validation_iter = input('Ingrese el m˙ltiplo de Èpocas para realizar una Època de validaciÛn  (validation_iter): ');

% Dataset Slicing
% config_option = input('Elija una configuraciÛn de distribuciÛn de datasets: \n1: 80-10-10\n2: 70-15-15\n');
config_option = 2;
